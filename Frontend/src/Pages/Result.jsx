...
export default function Result() {
  ...
  if (result.risk_level?.toLowerCase() === 'high' || result.risk_level === 'Malignant') {
  ...
  return (
    <AppShell
      ...
      title="Result"
      description="Review the predicted condition, confidence, and the top differential diagnoses."
      actions={
    ...
    >
        ...
        >
          ...
          <p className="text-gray-400">Primary detection based on deep learning analysis</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-8 w-full">
          ...
          >
            <h3 className="text-gray-400 text-sm font-bold uppercase tracking-wider mb-8">Model Confidence</h3>
          ...
          >
            <h3 className="text-gray-400 text-sm font-bold uppercase tracking-wider mb-6">Differential Diagnosis</h3>
        ...
        >
          ...
          <button 
            ...
            className="flex-1 bg-gray-800 hover:bg-gray-700 text-white font-medium py-3.5 px-6 rounded-2xl transition duration-300 ease-in-out transform hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2"
          >
            Back to Dashboard
          </button>
        </motion.div>
